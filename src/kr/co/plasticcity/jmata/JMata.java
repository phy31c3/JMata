...
public interface JMata
{
	...
	static JMInstantMachine buildInstantMachine(final Consumer<JMBuilder.BaseDefiner> builder)
	{
		return buildInstantMachine("Instant Machine#" + new Object().hashCode(), builder);
	}
	
	static JMInstantMachine buildInstantMachine(final String machineName, final Consumer<JMBuilder.BaseDefiner> builder)
	{
